...
public class BaiduAuditUtils {
    ...
    public static String getAuth() {
        ...
        String clientId = "8YUlAFLgGiVg2rlGSDT6Al2v";
        // 官网获取的 Secret Key 更新为你注册的
        String clientSecret = "WsXy4ANOnUUyXxGBv41AQSZWPebt0ZTL";
    ...
    public static boolean ImgAllCensor(String... imageUrls) {
        for (String imageUrl: imageUrls) {
            if (ImgCensor(imageUrl)) {
                return false;
            }
        }
        return true;
