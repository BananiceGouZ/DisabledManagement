        ...
        <div class="nav-table">
            ...
            <div class="nav-cont">
                <ul>
                    ...
                    <li class="qc"><a href="pet.html">宠物*</a></li>
                    <li class="qc"><a href="#">宠物服务*</a></li>
                    <li class="qc"><a href="#">宠物商品*</a></li>
                    <li class="qc"><a href="#">宠物百科*</a></li>
                    <li class="qc"><a href="#">宠物医疗*</a></li>
                    <li class="qc last"><a href="http://baidu.com">关于我们*</a></li>
                </ul>
                <div class="nav-extra">
            ...
            <div class="clearfixLeft" id="clearcontent">
                ...
                <div class="box">
                    ...
                    <div class="tb-booth tb-pic tb-s310">
                        <a :href="fastDfsPrefix + resourcesArr[0] + largeSuffix"><img
                                    :src="fastDfsPrefix + resourcesArr[0] + middleSuffix" alt="细节展示放大镜特效"
                                    :rel="fastDfsPrefix + resourcesArr[0] + largeSuffix" class="jqzoom"/></a>
                    </div>
                    <ul class="tb-thumb" id="thumblist">
                        <li v-for="(img,index) in resourcesArr">
                            <div v-if="index==0" class="tb-pic tb-s40 am-disabled tb-selected">
                                <a href="javascript:void(0)"><img :src="fastDfsPrefix + img + smallSuffix"
                                                                  :mid="fastDfsPrefix+img+middleSuffix"
                                                                  :big="fastDfsPrefix+img+largeSuffix"></a>
                            </div>
                            <div v-else class="tb-pic tb-s40 am-disabled">
                                <a href="javascript:void(0)"><img :src="fastDfsPrefix + img + smallSuffix"
                                                                  :mid="fastDfsPrefix+img+middleSuffix"
                                                                  :big="fastDfsPrefix+img+largeSuffix"></a>
                            </div>
            ...
            <div class="am-tabs-bd">
                ...
                <div class="am-tab-panel am-fade am-in am-active">
                    <div class="J_Brand">
                        ...
                        <div class="clear"></div>
                        <ul id="J_AttrUL">
                            <div v-html="pet.detail.intro"></div>
                        </ul>
                        <div class="clear"></div>
                    </div>
                    ...
                    <div class="details">
                        ...
                        <div class="twlistNews">
                            <ul id="J_AttrUL">
                                <div v-html="pet.detail.adoptNotice"></div>
                            </ul>
                        </div>
                    </div>
                    <div class="clear"></div>
...
<script type="text/javascript">
    $(document).ready(function () {
        ...
        $("#thumblist").on("click","li a",function() {
            $(this).parents("div").addClass("tb-selected").parents("li").siblings().find("div").removeClass("tb-selected");
    ...
    new Vue({
        ...
        data() {
            return {
                pet: {
                    name: '${name}',
                    saleprice: ${saleprice?string('0.00')},
                    resources: '${resources}',
                    detail: {
                        intro: '${detail.intro}',
                        adoptNotice: '${detail.adoptNotice}'
                    },
                    shop: {
                        name: '${shop.name}'
                    }
                ...
                resourcesArr: [],
                fastDfsPrefix: "http://123.207.27.208/",
                largeSuffix: '_800x800',
                middleSuffix: '_350x350',
                smallSuffix: '_60x60',
            }
        },
        methods: {},
        computed: {
            originalPrice() {
                return Math.floor(this.pet.saleprice * 1.4 * 100) / 100;
            }
        },
        mounted() {
            this.resourcesArr = this.pet.resources.split(",");
        }
    })
</script>
</body>
