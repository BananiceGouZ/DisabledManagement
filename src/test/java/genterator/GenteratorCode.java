...
public class GenteratorCode {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        strategy.setInclude(new String[]{"permission","role","menu"}); // 需要生成的表
        strategy.setSuperEntityClass("cn.bananice.basic.domain.BaseDomain");
        strategy.setSuperServiceClass("cn.bananice.basic.service.IBaseService");
        strategy.setSuperServiceImplClass("cn.bananice.basic.service.impl.BaseServiceImpl");
        strategy.setSuperMapperClass("cn.bananice.basic.mapper.BaseMapper");
